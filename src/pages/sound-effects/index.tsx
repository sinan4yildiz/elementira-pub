...
const PageSoundEffects = () => {
   const bg = app.assets.soundEffects.hero.bg[0]
   const categories = Object.entries(sortObject(app.assets.soundEffects.categories))

   return (
      <>
         <Meta
            title={trans('pages.soundEffects.metaTitle')}
            description={trans('elements.soundEffects.metaDescription')}
         />
         <Hero assetType={app.assets.soundEffects} video={bg.file} bgPlaceholder={bg.placeholder} />
         <section className="mx-auto mb-10 px-4 lg:max-w-screen-xl">
            ...
            <p className="mb-8 text-center text-sm font-light text-gray-600">
               {trans(`elements.${app.assets.soundEffects.name}.descriptionAlt`)}
            </p>
                  ...
                  <li key={key}>
                     <Link
                        href={{
                           ...
                           query: {
                              assetType: app.assets.soundEffects.name,
...
export default PageSoundEffects
