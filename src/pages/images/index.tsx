...
const PageImages = () => {
   const bg = app.assets.images.hero.bg[3]
   const categories = Object.entries(sortObject(app.assets.images.categories))

   return (
      <>
         <Meta title={trans('pages.images.metaTitle')} description={trans('elements.images.metaDescription')} />
         <Hero assetType={app.assets.images} image={bg.file} bgPlaceholder={bg.placeholder} />
         <section className="mx-auto mb-10 px-4 lg:max-w-screen-xl">
            ...
            <p className="mb-8 text-center text-sm font-light text-gray-600">
               {trans(`elements.${app.assets.images.name}.descriptionAlt`)}
            </p>
                  ...
                  <li key={key}>
                     <Link
                        href={{
                           ...
                           query: {
                              assetType: app.assets.images.name,
