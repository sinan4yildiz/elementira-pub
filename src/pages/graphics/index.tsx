...
const PageGraphics = () => {
   const bg = app.assets.graphics.hero.bg[2]
   const categories = Object.entries(sortObject(app.assets.graphics.categories))

   return (
      <>
         <Meta title={trans('pages.graphics.metaTitle')} description={trans('elements.graphics.metaDescription')} />
         <Hero assetType={app.assets.graphics} image={bg.file} bgPlaceholder={bg.placeholder} />
         <section className="mx-auto mb-10 px-4 lg:max-w-screen-xl">
            ...
            <p className="mb-8 text-center text-sm font-light text-gray-600">
               {trans(`elements.${app.assets.graphics.name}.descriptionAlt`)}
            </p>
                  ...
                  <li key={key}>
                     <Link
                        href={{
                           ...
                           query: {
                              assetType: app.assets.graphics.name,
