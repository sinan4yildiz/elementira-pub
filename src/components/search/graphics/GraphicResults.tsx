...
import { GraphicSearchResultsAssetType } from '@lib/graphics/types'
...
type PropsType = {
   foundAssets: GraphicSearchResultsAssetType[]
...
const GraphicResults = ({ foundAssets, collections, handleSave, likedAssets, handleLike }: PropsType) => {
   ...
   const [assets, setAssets] = useState<GraphicSearchResultsAssetType[][]>([])
   ...
   const onImageLoaded = async (e: any) => {
      adjustColumns()
   }
   ...
   const onSaveClick = async (asset: GraphicSearchResultsAssetType) => {
   ...
   const isSaved = (asset: GraphicSearchResultsAssetType) => {
   ...
   const onLikeClick = async (asset: GraphicSearchResultsAssetType) => {
   ...
   const isLiked = (asset: GraphicSearchResultsAssetType) => {
