import { graphicsFileTypeFilter } from '@components/search/graphics/filters/objects'
...
const { name, label, options } = graphicsFileTypeFilter

const FileTypeFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.fileType ? query.fileType.toString().split(',') : [])
