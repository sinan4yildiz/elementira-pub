import { graphicsLicenceFilter } from '@components/search/graphics/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = graphicsLicenceFilter

const LicenceFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.licence || null)
