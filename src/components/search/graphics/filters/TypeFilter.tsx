import { graphicsTypeFilter } from '@components/search/graphics/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = graphicsTypeFilter

const TypeFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.type || null)
