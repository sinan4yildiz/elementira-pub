import { musicVocalFilter } from '@components/search/music/filters/objects'
...
const { name, label, options } = musicVocalFilter

const VocalFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.vocal || null)
