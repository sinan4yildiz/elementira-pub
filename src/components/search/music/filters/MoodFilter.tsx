import { musicMoodFilter } from '@components/search/music/filters/objects'
...
const { name, label, options } = musicMoodFilter

const MoodFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.mood ? query.mood.toString().split(',') : [])
