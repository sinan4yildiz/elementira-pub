import { musicInstrumentFilter } from '@components/search/music/filters/objects'
...
const { name, label, options } = musicInstrumentFilter

const InstrumentFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.instrument ? query.instrument.toString().split(',') : [])
