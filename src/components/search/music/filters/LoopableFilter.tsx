import { musicLoopableFilter } from '@components/search/music/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = musicLoopableFilter

const LoopableFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.loopable || null)
