import { musicGenreFilter } from '@components/search/music/filters/objects'
...
const { name, label, options } = musicGenreFilter

const GenreFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.genre ? query.genre.toString().split(',') : [])
