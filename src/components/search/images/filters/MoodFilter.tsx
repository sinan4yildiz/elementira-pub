import { imagesMoodFilter } from '@components/search/images/filters/objects'
...
const { name, label, options } = imagesMoodFilter

const MoodFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.mood || null)
