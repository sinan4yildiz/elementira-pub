import { imagesAuthenticFilter } from '@components/search/images/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = imagesAuthenticFilter

const AuthenticFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.authentic || null)
...
export default AuthenticFilter
