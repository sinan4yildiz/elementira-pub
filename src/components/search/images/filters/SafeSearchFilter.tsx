import { imagesSafeSearchFilter } from '@components/search/images/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = imagesSafeSearchFilter

const SafeSearchFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.safeSearch || null)
