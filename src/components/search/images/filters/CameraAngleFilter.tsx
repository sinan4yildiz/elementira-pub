import { imagesCameraAngleFilter } from '@components/search/images/filters/objects'
...
const { name, label, options } = imagesCameraAngleFilter

const CameraAngleFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.cameraAngle || null)
...
export default CameraAngleFilter
