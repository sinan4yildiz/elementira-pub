import { imagesUndiscoveredFilter } from '@components/search/images/filters/objects'
import { RadioGroup } from '@headlessui/react'
import { useRouter } from 'next/router'
import React, { useState } from 'react'

const { name, label, options } = imagesUndiscoveredFilter

const UndiscoveredFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.undiscovered || null)
...
export default UndiscoveredFilter
