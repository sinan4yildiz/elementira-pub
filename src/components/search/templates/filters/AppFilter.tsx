import { templateAppFilter } from '@components/search/templates/filters/objects'
...
const { name, label, options } = templateAppFilter

const AppFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.app ? query.app.toString().split(',') : [])
