import { videoResolutionFilter } from '@components/search/video/filters/objects'
...
const { name, label, options } = videoResolutionFilter

const ResolutionFilter = () => {
   const { query } = useRouter()
   const [current, setCurrent] = useState(query.resolution ? query.resolution.toString().split(',') : [])
